  ...
  return (
    <div className="signup-wrapper">
      <div className="signup-container">
        <h1>Sign Up to AIHub</h1>
        <form onSubmit={handleSubmit}>
          {/* Personal information inputs */}
          <div className="form-row">
            <div className="form-group signup-firstname">
            ...
            <div className="form-group signup-lastname">
          ...
          <div className="form-row2">
            {/* Gender input */}
            <div className="form-group signup-gender">
            ...
            {/* Vocation input */}
            <div className="form-group signup-vocation">
